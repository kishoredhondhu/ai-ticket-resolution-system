...
class RAGEngine:
    ...
    def _init_huggingface_client(self) -> bool:
        ...
        try:
            ...
            # Using Mistral-7B - free and widely supported model
            # Alternative models: "meta-llama/Llama-3.2-3B-Instruct", "Qwen/Qwen2.5-Coder-32B-Instruct"
...
*This solution was generated by AI based on {len(similar_tickets)} similar resolved ticket(s).*"""
                    ...
                    deployment_name = os.getenv("HF_MODEL", "mistralai/Mistral-7B-Instruct-v0.3")
