...
Format your response as numbered steps without preamble."""
                    ...
                    suggested_resolution = f"""## Recommended Resolution

{ai_text}

---
**Confidence Level:** {avg_similarity:.0%} match based on historical ticket analysis
**Generated by:** AI-Powered Support System"""
