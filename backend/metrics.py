...
class MetricsTracker:
    ...
    def record_query(self, category: str, response_time: float, confidence: float, success: bool = True):
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'confidence_scores': {
                ...
                'avg': statistics.mean(self.confidence_scores) if self.confidence_scores else 0,
    ...
    def get_realtime_stats(self, limit: int = 100) -> Dict[str, Any]:
        ...
        recent_queries = self.queries[-limit:] if len(self.queries) > limit else self.queries
        ...
        return {
            ...
            'recent_categories': defaultdict(int, {
                ...
                q['category']: sum(1 for x in recent_queries if x['category'] == q['category'])
